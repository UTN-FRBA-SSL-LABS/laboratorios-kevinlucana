...
> R:Inicializa el carrito. Es importante para que una estructura pueda usarse.
...
> R:24. Al Total se le suma el precio del item correspondiente.

**P7** — ¿Qué debería hacer esa línea para calcular el total correctamente?

> R:Faltaria agregar que al total se le sume el precio del item y la cantidad.
...
> R:falla. [FAIL] test => esperado 0, obtenido 1.
...
> R:Lo detecto primero el test unitario.
...
> R:Comprueba diferente tipos de bugs al mismo tiempo en vez de ir viendo uno por uno.
...
> R:Porque faltaba multiplicar por la cantidad. En el test "test_total_precio_unitario" la cantidad era 1 mientras que "test_total_con_cantidad" era 2.
```
